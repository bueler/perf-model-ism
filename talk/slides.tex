...
\vspace{-3mm}
    ...
    \item[$\circ$] \emph{bed elevation} $b(x)$
    \end{itemize}
\item two outputs:
    \begin{itemize}
    \item[$\circ$] \emph{upper surface elevation} $s(t,x)$
    \item[$\circ$] \emph{ice velocity} $\bu(t,x)$
    \end{itemize}
...
\begin{itemize}
\item as this is a mathematics talk, more or less, some notation \dots
